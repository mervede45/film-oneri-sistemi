...
```
nlp-film-recommendation/
├── 🐍 PYTHON SCRIPTS
│   ├── data_preprocessing.py          # Ödev-1: Veri ön işleme
│   ├── model_training.py             # Ödev-1: Model eğitimi
│   └── similarity_evaluation.py      # Ödev-2: Benzerlik analizi ⭐
│
├── 📊 DATA & MODELS
│   ├── processed_data/               # İşlenmiş veriler
│   │   ├── processed_movies.csv
│   │   ├── lemmatized_sentences.csv  # 🚫 Boyut: GitHub limiti
│   │   ├── stemmed_sentences.csv     # 🚫 Boyut: GitHub limiti
│   │   ├── tfidf_lemmatized.csv      # 🚫 Boyut: GitHub limiti
│   │   └── tfidf_stemmed.csv         # 🚫 Boyut: GitHub limiti
│   │
│   └── models/                       # Eğitilmiş modeller
│       ├── *.model                   # 🚫 Word2Vec (16 adet)
│       └── tfidf_vectorizer.pkl
│
├── 📈 ANALYSIS RESULTS
│   ├── zipf_graphs/                  # Zipf yasası grafikleri
│   │   ├── zipf_comparison.png       # Karşılaştırmalı Zipf analizi
│   │   ├── zipf_ham_veri.png         # Ham veri Zipf analizi
│   │   ├── zipf_lemmatize_edilmiş_veri.png
│   │   └── zipf_stem_edilmiş_veri.png
│   │
│   ├── 🎯 ÖDEV-2 ÇIKTILARI
│   ├── similarity_evaluation_results.png  # Ana görselleştirme (4 panel)
│   ├── similarity_evaluation_report.txt   # Detaylı metin raporu
│   │
│   ├── MODEL COMPARISONS
│   ├── word_similarities_*.png            # Kelime benzerlik analizleri
│   │   ├── word_similarities_action.png   # 'action' kelimesi analizi
│   │   ├── word_similarities_hero.png     # 'hero' kelimesi analizi
│   │   ├── word_similarities_love.png     # 'love' kelimesi analizi
│   │   ├── word_similarities_movie.png    # 'movie' kelimesi analizi
│   │   └── word_similarities_villain.png  # 'villain' kelimesi analizi
│   │
│   ├── word_similarities_comparison_*.png # Model karşılaştırmaları
│   │   ├── word_similarities_comparison_action.png
│   │   ├── word_similarities_comparison_hero.png
│   │   ├── word_similarities_comparison_love.png
│   │   ├── word_similarities_comparison_movie.png
│   │   └── word_similarities_comparison_villain.png
│   │
│   ├── TF-IDF vs Word2Vec karşılaştırmaları
│   │   ├── comparison_love.png
│   │   ├── comparison_movie.png
│   │   └── comparison_action.png
│   │
│   ├── MODEL PARAMETER COMPARISONS
│   │   ├── model_type_comparison.png      # CBOW vs SkipGram
│   │   ├── preprocess_comparison.png      # Lemma vs Stem
│   │   ├── vector_size_comparison.png     # Vektör boyutu etkisi
│   │   └── window_size_comparison.png     # Pencere boyutu etkisi
│   │
│   ├── RECOMMENDATION RESULTS
│   │   ├── recommendation_comparison_titanic.png
│   │   └── recommendations.png
│   │
│   └── WORD2VEC TRAINING STATS
│       ├── w2v_model_sizes.png           # Model boyut karşılaştırması
│       ├── w2v_model_stats.csv           # Model istatistikleri
│       ├── w2v_training_times.png        # Eğitim süreleri
│       └── model_comparison_report.txt   # Kapsamlı model raporu
│
└── 📋 DOCUMENTATION
    └── README.md                          # Bu dosya
```
